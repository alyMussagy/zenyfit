...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-[100dvh] flex flex-col justify-end overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-zeny-green-dark/90 via-zeny-green-dark/40 to-zeny-green-dark/20" />
        <div className="absolute inset-0 bg-gradient-to-r from-black/30 to-transparent" />
      </div>

      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-24 sm:pt-32 pb-0">
        <div className="max-w-2xl">
          ...
          >
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-white/15 backdrop-blur-sm flex items-center justify-center border border-white/20">
              <svg viewBox="0 0 60 60" className="w-8 h-8 sm:w-9 sm:h-9" fill="none">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base font-medium text-white/70 tracking-wider uppercase mt-0.5">
          ...
          <motion.p
            className="text-base sm:text-lg text-white/80 leading-relaxed max-w-lg mb-6 sm:mb-8"
          ...
          >
            <a href="#produtos">
              <motion.button
                className="px-6 sm:px-8 py-3 bg-zeny-green text-white rounded-full font-medium shadow-lg shadow-zeny-green/30 text-sm sm:text-base"
            ...
            <a href="#sobre">
              <motion.button
                className="px-6 sm:px-8 py-3 border-2 border-white/30 text-white rounded-full font-medium text-sm sm:text-base backdrop-blur-sm hover:bg-white/10 transition-colors duration-200"
          ...
          >
            <div className="flex items-center gap-2">
              <Truck className="w-4 h-4 text-zeny-green-light" />
